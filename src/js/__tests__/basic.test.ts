...
test('add book', () => {
  ...
  expect(cart).toEqual({
    _items: [{
      author: 'orelly', id: 5, name: 'js', pages: 12, price: 10,
    }, {
      author: 'orelly', id: 6, name: 'ts', pages: 12, price: 20,
    }],
  });
});
test('get collection', () => {
...
test('add movie', () => {
  ...
  expect(cart).toEqual({
    _items: [{
      author: 'orelly', country: 'Russia', genre: 'Comedy', id: 5, name: 'js', price: 10, tagline: 'Soon', time: '1 hour', year: 2000,
    }, {
      author: 'orelly', country: 'Russia', genre: 'Comedy', id: 5, name: 'js', price: 10, tagline: 'Soon', time: '1 hour', year: 2000,
    }],
  });
